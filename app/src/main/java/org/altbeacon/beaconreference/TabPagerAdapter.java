...
public class TabPagerAdapter extends FragmentStatePagerAdapter
    ...
    private int titles[] = {R.drawable.button_1, R.drawable.button_2, R.drawable.button_3, R.drawable.button_3};
    ...
    public Fragment getItem(int i) {
        ...
        switch (i) {
            ...
            case 1:
                Log.d("tag", "getitem1");
                Page2 pg2 = Page2.createInstance();
